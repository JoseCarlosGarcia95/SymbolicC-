...
template <class T>
void Array<T, 1>::resize(int n)
{
   vector<T>::resize(n);
}

template <class T>
void Array<T, 1>::resize(vector<int> n)
{
   if (!n.empty())
      vector<T>::resize(n.front());
}

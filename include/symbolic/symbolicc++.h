...
#include "algebra/equation.hpp" //   Equation : CloningSymbolicInterface
#include "atoms/number.hpp" //   Numeric  : CloningSymbolicInterface
...
#include "calculus/functions.hpp" //     Sin    : Symbol ...
#include "geometry/symmatrix.hpp" //   SymbolicMatrix : CloningSymbolicInterface
#include "misc/symerror.hpp" //   SymbolicError  : CloningSymbolicInterface
#include "misc/constants.hpp"
#include "calculus/integrate.hpp"
#include "algebra/solve.hpp"
...
template <>
Symbolic zero(Symbolic);
template <>
Symbolic one(Symbolic);
...
template <>
Symbolic zero(Symbolic) { return Number<int>(0); }

template <>
Symbolic one(Symbolic) { return Number<int>(1); }

Equations
operator,
    (const Equation& x, const Equation& y)
{
    Equations l;
    l.push_back(x);
    l.push_back(y);
...
Equations
operator,
    (const Equations& x, const Equation& y)
{
    Equations l(x);
    l.push_back(y);
    return l;
...
Equations
operator,
    (const Equation& x, const Equations& y)
{
    Equations l(y);
    l.push_front(x);
    return l;
